...
import CoreEasyExercises from "../../molecules/CoreCardItemEasy/index";
...
const UpperBodyEasyScreen = ({ navigation }) => {
  const exercises = CoreEasyExercises;
  ...
  return (
    <View style={styles.container}>
      <ImageBackground style={styles.backgroundImageStyle} source={yellowBG}>
        {showGetReady ? (
          <View>
